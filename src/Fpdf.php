...
class Fpdf {
    ...
    *******************************************************************************/
    ...
    //modified function for barcode
    function Code39($xpos, $ypos, $code, $baseline=0.5, $height=5, $printNumber=1){
        ...
        #$this->Text($xpos-14, $ypos + $height + 4, $rawCode);
        $this->setY($ypos+$height);
        $this->setX($xpos-49);
        if($printNumber==1){
            $this->Cell(50,5,$rawCode,0,0,"R");
        }
